...
$JAVA_HOME/bin/javac -cp ./target/linkja-crypto-0.5.0.jar ./src/test/java/Test.java
...
$JAVA_HOME/bin/java -cp ./target/linkja-crypto-0.5.0.jar:./src/test/java -Djava.library.path=./target Test
