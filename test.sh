...
$JAVA_HOME/bin/javac -cp ./target/linkja-crypto-1.0.1.jar ./src/test/java/Test.java
...
$JAVA_HOME/bin/java -cp ./target/linkja-crypto-1.0.1.jar:./src/test/java -Djava.library.path=./target Test
